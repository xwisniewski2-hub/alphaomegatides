...
const PRODUCTS = [
  ...
  {id:"igf1lr3",name:"IGF-1 LR3",tag:"Growth Factor",icon:"📈",color:"#059669",hidden:true,
  ...
  {id:"dsip",name:"DSIP",tag:"Sleep Research",icon:"🌙",color:"#3730a3",hidden:true,
  ...
  {id:"mt2",name:"MT2",tag:"Sleep Research",icon:"🌛",color:"#312e81",
   sizes:[{s:"10mg",p:"$56.99"}],price:"$56.99",size:"10mg",
...
function HomeCatFilter({go,wishlist=[],toggleWishlist=()=>{}}){
  ...
  const filtered = PRODUCTS.filter(p=>{ if(p.hidden) return false;
...
// ── RESEARCH LIBRARY ─────────────────────────────
const ARTICLES = [
  {id:"glp-intro",title:"Understanding GLP Receptor Agonists",category:"Weight Loss",emoji:"🔥",time:"5 min read",summary:"How GLP-1, GLP-2, and GLP-3 receptors work differently and why triple agonism makes Retatrutide the most potent weight loss peptide studied to date.",tags:["GLP-3 R","GLP-2 T","GLP-1"],content:`**What are GLP Receptor Agonists?**

GLP (Glucagon-Like Peptide) receptor agonists are a class of peptides that mimic naturally occurring gut hormones. These hormones are released after eating and play a critical role in regulating appetite, blood sugar, and energy metabolism.

**GLP-1 (Semaglutide)**
GLP-1 receptors are found in the pancreas, brain, and gut. When activated they:
• Stimulate insulin secretion in a glucose-dependent manner
• Suppress glucagon release
• Slow gastric emptying (food stays in stomach longer)
• Signal satiety to the hypothalamus — reducing appetite

**GLP-2 T (Tirzepatide)**
Tirzepatide is a dual GIP/GLP-1 receptor agonist. GIP (Glucose-Dependent Insulinotropic Polypeptide) works synergistically with GLP-1:
• GIP enhances insulin secretion from beta cells
• Combined GIP+GLP-1 activation produces greater weight reduction than GLP-1 alone
• Phase 3 SURMOUNT trials showed up to 22.5% body weight reduction
...
• Triple agonism creates synergistic appetite suppression + metabolic acceleration
• Phase 2 data showed up to 24.2% weight reduction at 48 weeks — the highest published for any compound in this class

**Research Applications**
These compounds are studied for: obesity pharmacology, type 2 diabetes mechanisms, cardiovascular risk reduction, non-alcoholic fatty liver disease (NAFLD), and metabolic syndrome research.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"bpc-tb500",title:"BPC-157 + TB-500: The Ultimate Recovery Stack",category:"Recovery",emoji:"🛡️",time:"4 min read",summary:"Why these two peptides work synergistically — BPC-157 targets gut and tissue repair while TB-500 drives systemic actin-driven healing.",tags:["BPC-157","TB-500"],content:`**BPC-157 (Body Protection Compound)**

BPC-157 is a synthetic pentadecapeptide derived from a protective protein found in human gastric juice. It consists of 15 amino acids and has been extensively studied in animal models.

**Mechanisms of BPC-157:**
• Upregulates growth hormone receptors in tendon fibroblasts
• Promotes angiogenesis (new blood vessel formation) via VEGF pathway
• Protects and heals gastric mucosa and intestinal lining
• Accelerates wound healing via nitric oxide system modulation
• Exhibits anti-inflammatory properties by modulating cytokine expression

**TB-500 (Thymosin Beta-4 fragment)**

TB-500 is a synthetic analog of the naturally occurring peptide Thymosin Beta-4, specifically the actin-binding domain (residues 17-23).

**Mechanisms of TB-500:**
• Regulates actin polymerization — essential for cell migration and tissue remodeling
• Promotes stem cell differentiation and migration to injury sites
• Upregulates anti-inflammatory mechanisms
• Stimulates angiogenesis independently of BPC-157's pathways
• Crosses the blood-brain barrier — studied for neurological repair models

**Why They Stack Well**
BPC-157 and TB-500 operate through largely complementary pathways:
• BPC-157 = site-specific, gut-protective, faster onset
• TB-500 = systemic, longer-acting, structural remodeling
• Combined, they address both local tissue repair and body-wide healing signal cascades

**Research Protocol Notes:**
Both are lyophilized powders reconstituted with bacteriostatic water. Store reconstituted peptides at 2-8°C. Use within 28 days of reconstitution.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"gh-axis",title:"The GH Axis: CJC-1295, Ipamorlin & Tesamorlin",category:"Growth",emoji:"💪",time:"6 min read",summary:"Understanding the GHRH-pituitary-IGF-1 axis. How secretagogues differ from exogenous GH, and why pulsatile release matters.",tags:["CJC-1295","Ipamorelin","Tesamorlin"],content:`**The Growth Hormone Axis**

The hypothalamic-pituitary-GH-IGF-1 axis is one of the most studied endocrine systems in peptide research. Understanding how each compound interacts with this axis is fundamental to designing research protocols.

**Hypothalamus → GHRH → Pituitary → GH → Liver → IGF-1**

**CJC-1295 (Mod GRF 1-29)**
CJC-1295 without DAC is a 29-amino acid GHRH analogue with a half-life of approximately 30 minutes. This short half-life is intentional — it preserves the natural pulsatile pattern of GH secretion.

Key properties:
• Binds GHRH receptors on pituitary somatotrophs
• Stimulates GH pulse without disrupting the natural feedback loop
• Half-life of ~30 min makes it suitable for pulsatile research protocols

**Ipamorelin**
Ipamorelin is a selective GH secretagogue and ghrelin receptor agonist (GHSR-1a).

Key properties:
• Highly selective — minimal effect on cortisol, prolactin, or ACTH
• Stimulates GH via a completely separate receptor pathway from CJC-1295
• When combined with CJC-1295, produces 2-3x greater GH output than either alone
• Half-life of ~2 hours

**The CJC+Ipa Synergy**
Combining a GHRH analogue (CJC) with a ghrelin mimetic (Ipamorelin) saturates both pathways simultaneously. This dual-receptor approach is the most studied GH secretagogue stack in the literature.

**Tesamorlin**
Tesamorlin is a 44-amino acid GHRH analogue — the most clinically validated compound in this class. It was developed as Egrifta® for HIV-associated lipodystrophy.

Key properties:
• Phase 3 clinical trials in 800+ subjects
• 15-20% reduction in visceral adipose tissue documented over 26 weeks
• Dose-dependent IGF-1 elevation
• Longer half-life than Mod GRF 1-29

**IGF-1: The Downstream Mediator**
All GHRH analogues and secretagogues ultimately elevate IGF-1 through GH-mediated liver signaling. IGF-1 is the primary anabolic mediator — studied for protein synthesis, cell proliferation, and anti-apoptotic signaling.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"ghkcu-skin",title:"GHK-Cu: The Copper Peptide Activating 4,000+ Genes",category:"Skin & Anti-Age",emoji:"✨",time:"5 min read",summary:"GHK-Cu's mechanism on ECM remodeling, collagen synthesis, and how it regulates gene expression.",tags:["GHK-Cu","Glow Complex"],content:`**What is GHK-Cu?**

GHK-Cu (Copper Peptide GHK) is a naturally occurring tripeptide — Glycine-Histidine-Lysine — bound to copper (Cu²⁺). It was first isolated from human plasma in 1973 and has since become one of the most extensively studied peptides in aging and wound healing research.

**The 4,000+ Gene Finding**
A landmark microarray analysis published in 2010 found that GHK-Cu modulates the expression of over 4,000 human genes. This is the largest gene-regulatory effect documented for any single peptide. Key gene families affected include:
...
• DNA repair and anti-apoptotic pathways
• Antioxidant enzyme systems (SOD, catalase)

**Mechanisms of Action**
• **ECM Remodeling**: GHK-Cu simultaneously stimulates collagen synthesis AND activates MMPs to break down damaged/cross-linked collagen — net result is replacement of old collagen with new, properly structured collagen
• **Angiogenesis**: Promotes formation of new blood vessels via VEGF pathway
• **Anti-inflammatory**: Blocks NF-κB activation, reduces TNF-α and IL-6
• **Antioxidant**: Chelates free copper ions (preventing oxidative damage) while delivering copper to SOD enzymes

**Research Applications**
GHK-Cu is studied in: wound healing models, dermal aging research, hair follicle regeneration, neurological protection, COPD and lung tissue repair, and cancer research (particularly tumor suppressor gene activation).

**The Glow Complex**
Our Glow Complex combines GHK-Cu with TB-500 and BPC-157 — targeting ECM remodeling (GHK-Cu), structural repair signaling (TB-500), and angiogenesis/fibroblast activation (BPC-157) in a single research compound.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"nad-mito",title:"NAD+ & Mitochondrial Peptides for Longevity Research",category:"Longevity",emoji:"⚡",time:"7 min read",summary:"How NAD+ fuels sirtuin activation and DNA repair. The role of MOTS-c in metabolic regulation and why SS-31 is being studied for cardiac protection.",tags:["NAD+","MOTS-c","SS-31"],content:`**NAD+ (Nicotinamide Adenine Dinucleotide)**

NAD+ is the most fundamental coenzyme in cellular metabolism. Every cell in the body requires NAD+ to function — it is essential for glycolysis, the TCA cycle, oxidative phosphorylation, and dozens of signaling pathways.

**Why NAD+ Declines With Age**
NAD+ levels drop approximately 50% between ages 40-60. This decline is linked to:
• Increased PARP activity (DNA repair enzyme that consumes NAD+)
• Decreased NAMPT (rate-limiting enzyme in NAD+ biosynthesis)
• Elevated CD38 (NAD+-consuming enzyme that increases with inflammation)

**Sirtuin Activation**
The sirtuin family (SIRT1-7) are NAD+-dependent deacetylases — the most studied proteins in longevity research. Without adequate NAD+, sirtuins cannot function. Key sirtuin functions:
• SIRT1: Autophagy, mitochondrial biogenesis, fat metabolism
• SIRT3: Mitochondrial protein deacetylation, ROS reduction
• SIRT6: DNA repair, telomere maintenance, inflammation control

**MOTS-c (Mitochondrial ORF of the 12S rRNA type-c)**
MOTS-c is a remarkable 16-amino acid peptide encoded entirely within the mitochondrial genome — making it one of the few known mitochondria-derived signaling peptides (MDPs).

Key mechanisms:
• Activates AMPK (AMP-activated protein kinase) — the master metabolic switch
• Improves insulin sensitivity and glucose metabolism
• Upregulates antioxidant defenses via Nrf2 pathway
• Exercise-mimetic effects documented in mouse studies

**SS-31 (Elamipretide)**
SS-31 is a tetrapeptide (D-Arg-Dmt-Lys-Phe-NH2) that specifically targets the inner mitochondrial membrane by binding to cardiolipin.

Key mechanisms:
• Stabilizes cardiolipin — essential for electron transport chain (ETC) integrity
• Reduces mitochondrial reactive oxygen species (mROS)
• Preserves cristae structure under stress conditions
• In Phase 2/3 clinical trials for heart failure and Barth syndrome

**Why These Three Complement Each Other**
NAD+ replenishment + MOTS-c metabolic activation + SS-31 mitochondrial protection covers the three primary mechanisms of mitochondrial aging research simultaneously.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"neuro-peptides",title:"Selank, Semax & Cognitive Peptide Research",category:"Neuro",emoji:"🧠",time:"5 min read",summary:"How Russian-developed neuropeptides modulate BDNF, GABA, and stress response pathways.",tags:["Selank","Semax"],content:`**Background: Russian Neuropeptide Research**

Selank and Semax were both developed at the Institute of Molecular Genetics of the Russian Academy of Sciences beginning in the 1980s. Both are synthetic heptapeptides derived from ACTH (adrenocorticotropic hormone) fragments, specifically tuftsin (Selank) and ACTH(4-10) (Semax).

**Selank**
Selank is a synthetic analogue of the immunomodulatory peptide tuftsin (Thr-Lys-Pro-Arg) with the addition of Pro-Gly-Pro.

Mechanisms:
• **GABAergic modulation**: Selank enhances GABAergic transmission — the same pathway targeted by benzodiazepines, but without sedation or dependence
• **Enkephalin stabilization**: Inhibits enkephalin-degrading enzymes, prolonging endogenous opioid activity in stress-reduction pathways
• **BDNF elevation**: Studies show Selank increases brain-derived neurotrophic factor in the hippocampus
• **HPA axis normalization**: Reduces excessive cortisol response without blunting adaptive stress response

Research applications: anxiety models, PTSD research, immunomodulation, cognitive performance under stress.

**Semax**
Semax is a synthetic heptapeptide based on ACTH(4-7) with Pro-Gly-Pro added for stability: Met-Glu-His-Phe-Pro-Gly-Pro.

Mechanisms:
• **BDNF upregulation**: Most potent documented mechanism — significantly elevates BDNF in prefrontal cortex and hippocampus
• **Neuroprotection**: Protects neurons from ischemic damage, oxidative stress, and excitotoxicity
• **Dopamine/serotonin modulation**: Influences monoamine neurotransmitter systems
• **Cognitive enhancement**: Human studies showed improved memory consolidation and attention in healthy volunteers

Research applications: stroke recovery models, cognitive enhancement research, ADHD mechanisms, neuroprotection.

**Comparing Selank vs Semax**
• Selank → primarily anxiolytic, GABAergic, stress-reducing
• Semax → primarily pro-cognitive, neuroprotective, BDNF-elevating
• Combined → complementary coverage of anxiety-reduction + cognitive enhancement

Both are nasal spray or injectable preparations in research settings. Both have extensive Russian clinical literature dating to the 1990s.

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"recon-guide",title:"Complete Reconstitution Guide for Research Peptides",category:"Protocol",emoji:"🧪",time:"8 min read",summary:"Step-by-step: bacteriostatic water vs acetic acid, storage temperatures, vial lifespan, and how to calculate your draw volume.",tags:["All Products"],content:`**What is Reconstitution?**

Research peptides are supplied as lyophilized (freeze-dried) powder to maximize stability during storage and shipping. Before use in research, they must be reconstituted — dissolved in an appropriate sterile liquid.
...
• Reconstituted peptides stable for 14-28 days at 2-8°C
• ✅ Recommended for most research peptides

Sterile Water:
• No preservative — single use only
• Reconstituted peptide should be used within 24 hours
• Use only if benzyl alcohol is contraindicated in your research model

Acetic Acid (0.6%):
• Required for IGF-1 LR3 — will not dissolve properly in BAC water
• Use 0.6% acetic acid, then dilute in PBS for application

**Step-by-Step Reconstitution Protocol**

1. Allow lyophilized vial to reach room temperature (15-20 min)
2. Clean the rubber stopper with an alcohol swab — let dry
3. Draw your desired BAC water volume into a 1mL insulin syringe
4. Insert needle at an angle against the glass wall of the peptide vial
5. Let BAC water run slowly down the glass — do NOT inject directly onto the powder
6. Gently swirl (never shake) until fully dissolved — solution should be clear
7. Label vial with date and concentration
8. Store at 2-8°C (refrigerator)

**Calculating Concentration & Draw Volume**

Formula: Volume to draw (mL) = Desired dose (mcg) ÷ Concentration (mcg/mL)

Example — BPC-157 (10mg vial):
• Add 2mL BAC water → concentration = 5,000 mcg/mL (5mg/mL)
• For 250mcg dose: 250 ÷ 5000 = 0.05mL = 5 units on U-100 syringe
• For 500mcg dose: 500 ÷ 5000 = 0.10mL = 10 units on U-100 syringe

**Storage Guidelines**
• Lyophilized (unreconstituted): 2-8°C for up to 24 months; -20°C for longer term
• Reconstituted: 2-8°C for 14-28 days depending on compound
• Never freeze reconstituted peptides
• Keep away from light and heat

**Syringe Selection**
• U-100 insulin syringes (1mL) are standard for research peptide administration
• Needle gauge: 27-31G for subcutaneous injection in animal models
• Rotate injection sites in prolonged research protocols

⚠️ For in-vitro and laboratory research use only. Not for human consumption.`},

  {id:"cycling",title:"Research Cycling Protocols: When to Run, When to Rest",category:"Protocol",emoji:"📋",time:"6 min read",summary:"Evidence-based cycling frameworks for GLP peptides, GH secretagogues, and healing peptides.",tags:["GLP-3 R","CJC-1295","BPC-157"],content:`**Why Cycling Matters in Peptide Research**

Cycling refers to periods of compound administration followed by rest periods. In research models, cycling is used to:
• Prevent receptor downregulation and desensitization
• Maintain responsiveness of target pathways
• Study washout kinetics and duration of effect
• Model real-world usage patterns for pharmacokinetic research

**GLP Peptide Cycling**

GLP-1, GLP-2 T, and GLP-3 R are typically studied in continuous administration protocols in clinical trials (weekly injections). For research models:
• Short-term studies: 4-12 week continuous protocols are standard
• Long-term studies: some researchers use 16-on / 4-off cycles
• Receptor sensitivity: GLP receptors show minimal downregulation at therapeutic doses in published literature
• Washout: GLP-1 analogues typically clear within 1-3 weeks

**GH Secretagogue Cycling (CJC-1295, Ipamorelin, Tesamorlin)**

GH secretagogues require more careful cycling to prevent somatostatin feedback:
• Standard research cycle: 12 weeks on / 4 weeks off
• The pituitary requires rest periods to maintain sensitivity
• 5-on / 2-off weekly patterns are also studied (weekday dosing)
• IGF-1 levels typically normalize within 2-4 weeks of cessation

**Healing Peptide Protocols (BPC-157, TB-500)**

Healing peptides are often studied in shorter, targeted protocols:
• BPC-157: 4-6 week acute protocols for injury models; continuous low-dose for gut research
• TB-500: 4-6 week loading phase research protocols
• Both show activity in acute single-dose models as well
• Minimal receptor downregulation documented in literature

**Stacking Considerations**
When multiple compounds are used in research:
• GH secretagogues + healing peptides: compatible, different receptor systems
• GLP peptides + GH axis compounds: studied separately in most published literature
• NAD+ and mitochondrial peptides: generally compatible as continuous protocols

**Washout Periods**
• Short-acting peptides (CJC No DAC, Ipamorelin): 2-4 week washout
• Long-acting analogues (Tesamorlin, GLP analogues): 4-6 week washout
• Healing peptides: 2-3 week washout standard
...
function ResearchLibraryPage({go}){
  ...
  if(selected) return <div style={{paddingTop:70,background:"#0e0e0e",minHeight:"100vh",color:"#fff"}}>
    <div style={{maxWidth:720,margin:"0 auto",padding:"32px 20px 80px"}}>
      ...
      {selected.content && (
        <div style={{fontSize:"0.9rem",color:"rgba(255,255,255,0.75)",lineHeight:1.85,marginBottom:24}}>
          {selected.content.split('\n').map((line,i)=>{
            if(line.startsWith('**')&&line.endsWith('**')) return <div key={i} style={{fontFamily:"'Syne',sans-serif",fontWeight:800,fontSize:"1rem",color:"#fff",marginTop:24,marginBottom:8}}>{line.replace(/\*\*/g,'')}</div>;
            if(line.startsWith('•')) return <div key={i} style={{paddingLeft:16,marginBottom:6,color:"rgba(255,255,255,0.65)"}}>{line}</div>;
            if(line.startsWith('✅')) return <div key={i} style={{paddingLeft:16,marginBottom:6,color:"#3be8b0"}}>{line}</div>;
            if(line.startsWith('⚠️')) return <div key={i} style={{marginTop:16,background:"rgba(255,107,107,0.07)",border:"1px solid rgba(255,107,107,0.15)",borderRadius:10,padding:"12px 16px",fontSize:"0.75rem",color:"rgba(255,150,130,0.8)"}}>{line}</div>;
            if(line===''&&i>0) return <div key={i} style={{height:8}}/>;
    ...
    try {
      await fetch("https://api.resend.com/emails", {
        ...
        headers: {
          ...
          "Authorization": "Bearer re_gNzYdNZU_4Yx2Y916iJb6dSiBniGRchZF"
        },
        body: JSON.stringify({
          from: "Alphaomegatides <onboarding@resend.dev>",
          to: [u.email],
          subject: "Welcome to Alphaomegatides — Account Created",
          html: `
            <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#0e0e0e;color:#fff;padding:40px;border-radius:16px;">
              <div style="font-size:2rem;margin-bottom:8px;">α Ω</div>
              <h1 style="font-family:sans-serif;font-size:1.4rem;font-weight:800;margin-bottom:8px;">Welcome to Alphaomegatides</h1>
              <p style="color:rgba(255,255,255,0.6);margin-bottom:24px;line-height:1.7;">Hi ${u.fname}, your research account has been created successfully.</p>
              <div style="background:#1a1a1a;border-radius:12px;padding:20px;margin-bottom:24px;">
                <div style="font-size:0.8rem;color:rgba(255,255,255,0.4);margin-bottom:4px;">Account Email</div>
                <div style="font-weight:600;">${u.email}</div>
              </div>
              <p style="color:rgba(255,255,255,0.5);font-size:0.85rem;line-height:1.7;">All products are for in-vitro laboratory research use only. Not for human consumption.</p>
              <div style="margin-top:32px;padding-top:20px;border-top:1px solid rgba(255,255,255,0.1);font-size:0.75rem;color:rgba(255,255,255,0.3);">
                Alphaomegatides · alphaomegatides@yahoo.com<br/>
                "Where the tide turns for all."
              </div>
            </div>
          `
        })
