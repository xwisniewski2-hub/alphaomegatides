...
const BOT_QA = [
  ...
  {q:["return","refund","wrong","issue","problem","damaged"],
   a:"Please contact us at xwisniewski2@icloud.com for any order issues. If there is a documented purity issue or fulfillment error, we will work to resolve it promptly. Include your order number and description of the issue."},
  {q:["contact","email","reach","support","help","question"],
   a:"Reach us at xwisniewski2@icloud.com or visit the Contact page in the nav. We typically respond within 1 business day. For research protocol questions, order issues, or COA documentation requests — we're here to help."},
  // ── Legal / Safety ──
...
function getBotReply(input) {
  ...
  return "That's a great research question. I don't have a specific answer for that in my knowledge base, but you can reach our team directly at xwisniewski2@icloud.com — we typically respond within 1 business day. You can also find detailed documentation on each product page.";
}
  ...
  return <div style={{paddingTop:70,background:"#0e0e0e",minHeight:"100vh"}}>
    <div style={{maxWidth:480,margin:"0 auto",padding:"48px 20px 80px"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:28}}>
        {[
          ["📧","Email","xwisniewski2@icloud.com","mailto:xwisniewski2@icloud.com"],
          ["📦","Order Support","Questions about an existing order","mailto:xwisniewski2@icloud.com"],
          ["🔬","COA & Research Docs","Request lab reports or documentation","mailto:xwisniewski2@icloud.com"],
      ...
      {/* CTA */}
      <a href="mailto:xwisniewski2@icloud.com"
      ...
      <div style={{textAlign:"center",marginTop:10,fontSize:"0.72rem",color:C.muted}}>xwisniewski2@icloud.com</div>
  ...
  return <LegalPage title="Refund Policy" go={go}>
    ...
    <LegalSection title="Receipt of Damaged or Incorrect Goods">
      ...
      <ol style={{marginTop:10,marginLeft:20,display:"flex",flexDirection:"column",gap:6}}>
        ...
        <li>Email the images and a brief description to <strong>xwisniewski2@icloud.com</strong> within <strong>48 hours</strong> of the carrier's delivery timestamp.</li>
      </ol>
    ...
    <LegalSection title="Questions">
      For clarifications prior to ordering, contact us at <strong>xwisniewski2@icloud.com</strong>. Requests received after an order is placed will be handled in accordance with the "All Sales Are Final" clause above.
    </LegalSection>
  </LegalPage>;
}
...
function PrivacyPage({go}){
  return <LegalPage title="Privacy Policy" go={go}>
    ...
    <LegalSection title="Contact">
      For privacy questions or to exercise your rights: <strong>xwisniewski2@icloud.com</strong>
    </LegalSection>
  </LegalPage>;
}
