...
const NOTIFY_EMAIL   = "xwisniewski2@icloud.com";
...
const BUNDLES = [
  {
    ...
    name:"Weight Loss Starter Stack",
    icon:"🔥",
    color:"#ff6b6b",
  ...
  },
  {
    ...
    color:"#3be8b0",
    ids:["bpc157","tb500"],
    desc:"The classic dual-pathway healing stack — tissue repair + systemic actin remodeling.",
    savings:"Save $10",
  },
  {
    id:"neuro-stack",
...
const QUIZ_QUESTIONS = [
  {
    ...
    opts:[
      ...
      {label:"Tissue Repair & Recovery",ids:["bpc157","tb500","ghkcu"]},
      {label:"GH Axis & Body Composition",ids:["cjcipa","cjc1295","ipamorlin","tesamorlin","igf1lr3"]},
      {label:"Longevity & Cellular Health",ids:["nad","motsc","ss31","glutathione"]},
      {label:"Cognitive & Neurological",ids:["selank","semax","dsip","mt2"]},
      {label:"Skin & Anti-Aging",ids:["ghkcu","glow","nad"]},
    ]
  },
  {
  ...
  },
  {
    ...
    opts:[
      {label:"Fat loss / metabolic optimization",ids:["glp3r","glp2t","glp1","tesamorlin","motsc"]},
      {label:"Recovery / injury repair",ids:["bpc157","tb500","ghkcu","glow"]},
      {label:"Muscle / body recomposition",ids:["cjcipa","cjc1295","ipamorlin","igf1lr3"]},
      {label:"Anti-aging / longevity",ids:["nad","ss31","ghkcu","glutathione","motsc"]},
      {label:"Cognitive function / sleep",ids:["selank","semax","dsip","mt2"]},
    ]
  },
];
