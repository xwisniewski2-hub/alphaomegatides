...
const VIDEO_TUTORIALS = [
  // ── FOUNDATIONS ──────────────────────────────────────────────────────────
  { id:"bac-water",        title:"How to Mix Peptides with Bacteriostatic Water", compound:"All Products", duration:"8:14", thumb:"💧", ytId:"K0R7pZM0Bjw", level:"Beginner", desc:"The easiest step-by-step guide to reconstituting any peptide with BAC water — the foundation of all peptide research." },
  { id:"reconst-general",  title:"How to Reconstitute Peptides — Step by Step", compound:"All Products", duration:"6:22", thumb:"🧪", ytId:"kRqC01t6TLc", level:"Beginner", desc:"Full walkthrough: aseptic technique, rolling vs shaking, and how to draw your first dose cleanly." },
  { id:"doctor-prep",      title:"Doctor Explains How to Correctly Prepare & Inject Peptides", compound:"All Products", duration:"11:30", thumb:"👨‍⚕️", ytId:"L65S1xmKY44", level:"Beginner", desc:"Board-certified physician walks through exact gear, reconstitution technique, and injection method." },
  { id:"reconst-calc",     title:"Peptide Reconstitution Calculator — 45+ Compounds", compound:"All Products", duration:"9:05", thumb:"🧮", ytId:"kMBxX2jaiKE", level:"Beginner", desc:"Free calculator walkthrough for BPC-157, TB-500, Semaglutide, Tirzepatide, Ipamorelin, CJC-1295 and 45+ compounds. No math required." },
  // ── GLP METABOLIC CLASS ──────────────────────────────────────────────────
  { id:"glp-shot-guide",   title:"How to Take a GLP-1 Shot — Step-by-Step Routine", compound:"GLP-1 / GLP-2 T / GLP-3 R", duration:"7:18", thumb:"🔥", ytId:"dxkllues8-w", level:"Beginner", desc:"Covers Semaglutide, Tirzepatide, and Retatrutide — exactly how to prepare and inject GLP-1 class peptides." },
  { id:"retrat-recon",     title:"Reconstitution Retatrutide — How to Properly Reconstitute GLP-1 Peptides", compound:"GLP-3 R (Retatrutide)", duration:"10:45", thumb:"🔥", ytId:"u2UZ6uVz6VI", level:"Beginner", desc:"Education-first walkthrough: BAC water ratios, titration math, and storage for Retatrutide." },
  { id:"retrat-stack",     title:"Doctor Explains What to Stack with Retatrutide to Maximize Results", compound:"GLP-3 R (Retatrutide)", duration:"14:22", thumb:"🔥", ytId:"NdGKQ4aH7hI", level:"Intermediate", desc:"Strategic peptide stacking with Retatrutide — BPC-157, GHK-Cu, and longevity compound combinations." },
  { id:"glp-mix",          title:"Walking a Newbie Through Reconstituting Tirzepatide & Semaglutide", compound:"GLP-1 / GLP-2 T", duration:"8:33", thumb:"💊", ytId:"UrP3WGRHnVA", level:"Beginner", desc:"Complete beginner-friendly reconstitution demo covering every stage from unpacking the vial to first draw." },
  // ── TISSUE REPAIR & RECOVERY ─────────────────────────────────────────────
  { id:"bpc-complete",     title:"BPC-157 — A Complete How-To Guide", compound:"BPC-157", duration:"18:40", thumb:"🧬", ytId:"0GpNUIdDric", level:"Intermediate", desc:"Stacking with TB-500, terminology, dosing schedules, reconstitution calculations, and injection technique." },
  { id:"bpc-recon-dr",     title:"How to Reconstitute BPC-157 — Dr. Faler, Anti-Aging Northwest", compound:"BPC-157", duration:"5:12", thumb:"🧬", ytId:"59L1fuCcnmY", level:"Beginner", desc:"Clinical demonstration covering full reconstitution, site-specific injection guidance, and storage." },
  { id:"bpc-tb-wolverine", title:"BPC-157 + TB-500 Wolverine Stack — Measure & Inject", compound:"BPC-157 / TB-500", duration:"12:08", thumb:"🛠️", ytId:"rNEgtpZnlwg", level:"Intermediate", desc:"Side-by-side reconstitution and injection guide for the BPC-157 + TB-500 recovery stack." },
  { id:"bpc-tb-protocols", title:"Ultimate Guide — BPC-157 & TB-500 Complete Protocols", compound:"BPC-157 / TB-500", duration:"22:15", thumb:"🛡️", ytId:"-2PWehnVsyo", level:"Intermediate", desc:"Clinical protocols: reconstitution, dosing schedules, site injection, cycling, and stacking strategies." },
  { id:"tb500-clinical",   title:"Unlocking TB-500 — Dosage, Benefits & Clinical Success", compound:"TB-500", duration:"16:50", thumb:"🛠️", ytId:"OffXGrrzI3A", level:"Intermediate", desc:"Dr. Adam Sewell's clinical training on TB-500: regenerative medicine applications, dosing, and outcomes." },
  // ── GH AXIS — CJC / IPAMORELIN / TESAMORELIN / IGF-1 ───────────────────
  { id:"cjc-ipa-science",  title:"Real Doctor Explains CJC-1295 + Ipamorelin — The Classic Stack", compound:"CJC-1295 / Ipamorelin", duration:"13:44", thumb:"🔬", ytId:"kdQ83_Je_qs", level:"Intermediate", desc:"Dr. Froese breaks down the GH release mechanism and why this is the most popular GH research stack." },
  { id:"cjc-ipa-recon",    title:"How to Reconstitute the Ipamorelin & CJC-1295 Stack", compound:"CJC-1295 / Ipamorelin Blend", duration:"9:16", thumb:"⚡", ytId:"ycvK3qDdIkk", level:"Beginner", desc:"Step-by-step reconstitution for both CJC-1295 and Ipamorelin together, including draw volume calculation." },
  { id:"cjc-recon",        title:"How to Reconstitute CJC-1295 (DAC/No DAC) — Simple Tutorial", compound:"CJC-1295", duration:"6:30", thumb:"🔬", ytId:"WXkN-96N9bc", level:"Beginner", desc:"Beginner tutorial for CJC-1295 with or without DAC using bacteriostatic water. Covers both variants." },
  { id:"cjc-dosage",       title:"CJC-1295 No DAC / Ipamorelin Dosage & Reconstitution", compound:"CJC-1295 / Ipamorelin", duration:"11:02", thumb:"⚗️", ytId:"QTy10-b_arA", level:"Intermediate", desc:"Detailed dosage walkthrough: vial math, BAC water ratios, timing protocols, and cycling strategies." },
  { id:"tesamorelin-recon",title:"How to Reconstitute 5mg Tesamorelin — Step by Step", compound:"Tesamorlin", duration:"7:45", thumb:"💪", ytId:"VMUp3bLN4b4", level:"Beginner", desc:"Complete mixing guide for Tesamorelin with concentration math and storage best practices." },
  { id:"igf1-recon",       title:"How to Reconstitute IGF-1 LR3 Peptide — Beginner Guide", compound:"IGF-1 LR3", duration:"8:20", thumb:"📈", ytId:"CiB8AypKheo", level:"Beginner", desc:"Easy step-by-step tutorial for properly reconstituting IGF-1 LR3 using bacteriostatic water." },
  // ── COPPER, SKIN & GLOW ─────────────────────────────────────────────────
  { id:"ghkcu-recon",      title:"GHK-Cu Peptide — Reconstitution & Dilution (Reduce Injection Pain)", compound:"GHK-CU", duration:"10:18", thumb:"✨", ytId:"BOmmLfsMFtE", level:"Beginner", desc:"How to reconstitute GHK-Cu with dilution strategies to reduce injection site burning." },
  { id:"ghkcu-doses",      title:"How to Reconstitute GHK-Cu & Calculate Doses", compound:"GHK-CU", duration:"7:55", thumb:"✨", ytId:"KsbuEZz1HbI", level:"Beginner", desc:"Dose calculation walkthrough using a peptide calculator. Step-by-step mixing with concentration math." },
  { id:"glow-recon",       title:"How to Reconstitute the Glow Stack — GHK-Cu, BPC-157, TB-500", compound:"Glow Complex", duration:"4:30", thumb:"🌟", ytId:"7D788tlYHnc", level:"Beginner", desc:"Quick reconstitution demo: 70mg Glow Stack vial with 3ml BAC water. Rotate, don't shake." },
  // ── LONGEVITY & MITOCHONDRIAL ────────────────────────────────────────────
  { id:"nad-recon",        title:"How to Reconstitute & Inject NAD+", compound:"NAD+", duration:"5:44", thumb:"⚗️", ytId:"S43wXN12uKE", level:"Beginner", desc:"Nurse Cassie shows exactly how to mix and inject NAD+ at home — step by step from vial to syringe." },
  { id:"motsc-recon",      title:"How to Mix MOTS-c — Optimal Dosage & Reconstitution", compound:"MOTS-c", duration:"9:12", thumb:"🔋", ytId:"snq8c5SSSww", level:"Beginner", desc:"5mg and 10mg MOTS-c reconstitution with best protocol ranges for mitochondrial health research." },
  { id:"ss31-recon",       title:"How to Reconstitute SS-31 Peptide — Full Mixing Guide", compound:"SS-31", duration:"8:40", thumb:"🔋", ytId:"-4_4zreVVGs", level:"Beginner", desc:"Complete reconstitution guide for SS-31 (Elamipretide). Covers vial prep, BAC water, and syringe draw." },
  { id:"ss31-motsc-proto", title:"Updated SS-31 + MOTS-c Protocol 2026", compound:"SS-31 / MOTS-c", duration:"12:30", thumb:"⚡", ytId:"Arx8CD6TA0Y", level:"Intermediate", desc:"2026 updated sequential protocol based on new Gudiksen et al. study. Repair with SS-31 first, then optimize with MOTS-c." },
  { id:"glutathione-recon",title:"How to Reconstitute Glutathione", compound:"Glutathione", duration:"7:10", thumb:"🌱", ytId:"Mk0fj3vGeSo", level:"Beginner", desc:"What you need, what reconstituting glutathione looks like, and how to prepare your first dose correctly." },
  // ── COGNITIVE & SLEEP ────────────────────────────────────────────────────
  { id:"semax-selank-inj", title:"Intranasal vs Injection — Semax & Selank Methods Compared", compound:"Selank / Semax", duration:"13:20", thumb:"🧠", ytId:"G7FATd2CZaI", level:"Intermediate", desc:"Side-by-side comparison of intranasal and injectable Semax + Selank. Reconstitution, dosing math, and method selection." },
  { id:"semax-selank-spray",title:"How to Mix Semax or Selank into a Nasal Spray", compound:"Selank / Semax", duration:"3:45", thumb:"🧬", ytId:"JtvBhmMcdkk", level:"Beginner", desc:"Step-by-step guide to mixing Semax and Selank into a nasal spray bottle for convenient dosing." },
  { id:"dsip-guide",       title:"DSIP — How to Dose, Mix & Reconstitute for Research", compound:"DSIP", duration:"11:25", thumb:"🌙", ytId:"ywypMgDjWQ4", level:"Beginner", desc:"Complete DSIP research guide: how to dose, mix, and reconstitute Delta Sleep Inducing Peptide." },
  { id:"dsip-science",     title:"DSIP — Comprehensive Guide by a Sleep Expert", compound:"DSIP", duration:"16:40", thumb:"🌙", ytId:"zG5GKyt0t2U", level:"Intermediate", desc:"Deep dive into DSIP: mechanisms, research history, dosing approaches, and sleep stack considerations." },
  { id:"mt2-reconst",      title:"How to Use Melanotan 2 (MT2) — Reconstitution & Dosing", compound:"MT2", duration:"5:20", thumb:"🌛", ytId:"agZxQY5i0Ls", level:"Beginner", desc:"MT2 reconstitution: 10mg vial with 2mL BAC water, dosing approaches, and injection overview." },
];
