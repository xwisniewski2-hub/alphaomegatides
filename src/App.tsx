...
const PRODUCTS = [
  ...
  {id:"glow",name:"Glow Complex",tag:"Skin Research",icon:"🌟",color:"#ec4899",
   ...
   desc:"Skin supportth research blend: GHK-Cu + BPC-157 + Thymosin Beta-4. Three peptides studied for matrix modulation, tissue repair, and cellular tissue supportion.",
   coa:{purity:"99%+",labs:["Freedom Diagnostics"],tests:[
...
const PRODUCT_META = {
  "glp3r":{bestFor:["metabolic research","Appetite Control","Metabolic supportth"],difficulty:"Intermediate",stacks:["glp2t","bpc157","tb500"]},
  "glp2t":{bestFor:["metabolic research","GI supportth","Metabolic"],difficulty:"Intermediate",stacks:["glp3r","bpc157"]},
  "glp1":{bestFor:["metabolic research","Blood Sugar","Appetite"],difficulty:"Beginner",stacks:["glp2t","bpc157"]},
  "bpc157":{bestFor:["Gut supporting","Tissue Repair","Joint post-research support"],difficulty:"Beginner",stacks:["tb500"]},
  ...
  "ipamorlin":{bestFor:["GH Release","sleep research","post-research support"],difficulty:"Beginner",stacks:["cjc1295","dsip"]},
  "tesamorlin":{bestFor:["Visceral Fat","Body Composition","GH"],difficulty:"Intermediate",stacks:["cjcipa","igf1lr3"]},
  "igf1lr3":{bestFor:["anabolic research","Cell Repair","post-research support"],difficulty:"Advanced",stacks:["cjcipa","tb500"]},
  "ghkcu":{bestFor:["Skin supportth","longevity research","Wound supporting"],difficulty:"Beginner",stacks:["glow","nad"]},
  ...
  "ss31":{bestFor:["Mitochondria","Heart supportth","Longevity"],difficulty:"Advanced",stacks:["nad","motsc"]},
  ...
  "dsip":{bestFor:["Deep Sleep","Circadian Reset","post-research support"],difficulty:"Beginner",stacks:["ipamorlin"]},
...
const RESEARCH_POTENTIAL: Record<string,{headline:string,points:{icon:string,label:string,detail:string}[]}> = {
  ...
  "tesamorlin":{headline:"What researchers study this for",points:[
    ...
    {icon:"🔬",label:"GHRH Analogue Research",detail:"As a 44-amino-acid GHRH analogue, Tesamorlin is the most researchly validated compound in this class with extensive Phase 2/3 data."},
  ]},
  ...
  "ss31":{headline:"What researchers study this for",points:[
    ...
    {icon:"❤️",label:"Cardiac Research",detail:"SS-31 (Elamipretide) is in Phase 2/3 research trials for heart failure and ischemia-reperfusion subject tissue — the most researchly advanced mitochondria-targeted peptide."},
...
const QUIZ_QUESTIONS = [
  {
    ...
    opts:[
      ...
      {label:"Longevity & Cellular supportth",ids:["nad","motsc","ss31","glutathione"]},
      {label:"Cognitive & Neurological",ids:["selank","semax","dsip","mt2"]},
      {label:"Skin & longevity research",ids:["ghkcu","glow","nad"]},
    ]
  },
  {
...
const HOME_CATS = [
  ...
  {id:"glp",       label:"metabolic research",      emoji:"🔥", ids:["glp3r","glp2t","glp1"]},
  {id:"post-research support",  label:"post-research support",         emoji:"🛡️", ids:["bpc157","tb500","ghkcu","glow"]},
...
const NAV_CATS = [
  ...
  {label:"post-research support & supporting",emoji:"🛡️",ids:["bpc157","tb500","ghkcu","glow"],                                 catId:"post-research support"},
...
function Home({go,recentlyViewed=[],wishlist=[],toggleWishlist=()=>{}}){
  return <div style={{paddingTop:70,background:"#0e0e0e",color:"#ffffff"}}>
    <section style={{minHeight:"90vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"80px 24px 60px",background:"#0a0a0a",position:"relative",overflow:"hidden"}}>
      ...
      <h1 style={{fontFamily:"'Syne',sans-serif",fontSize:"clamp(1.6rem,3.5vw,2.4rem)",fontWeight:800,lineHeight:1.1,letterSpacing:"-.03em",maxWidth:560,position:"relative",zIndex:1,margin:"0 0 16px",color:"#ffffff"}}>
      ...
      <p style={{fontSize:"0.9rem",color:"rgba(255,255,255,0.45)",maxWidth:460,lineHeight:1.65,marginBottom:6,position:"relative",zIndex:1}}>
        Research-grade peptides with independent third-party verification, full documentation, and US-only fulfillment.
      </p>
      ...
      <div className="footer-grid" style={{maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:36,marginBottom:36}}>
        ...
        <div>
          ...
          {[
            ...
            {label:"🛡️ post-research support & supporting",catId:"post-research support"},
